...
type SearchRequest struct {
	...
	// user is optional and maps to GitHub's "user:" search qualifier, i.e. it
	// scopes results to repos owned by that account. It does not identify the
	// caller.
...
const file_proto_search_proto_rawDesc = "" +
	"\n" +
	"\x12proto/search.proto\x12\x0fgithubsearch.v1\"D\n" +
	...
	"\x06Search\x12\x1e.githubsearch.v1.SearchRequest\x1a\x1f.githubsearch.v1.SearchResponseBGZEgithub.com/shashank8956/github-search-service/proto/searchpb;searchpbb\x06proto3"
